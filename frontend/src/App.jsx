...
import AddTransaction from "./component/AddData/AddTransaction.jsx"
    ...
    return (
      <FinanceProvider user={user}>
        ...
        <Routes>
          ...
          <Route
            path="/addTransaction"
            element={<AddTransaction user={user} />} 
          />
            {/* <Route path="addIncome" element={<AddIncome user={user}  />} />
            <Route path="addExpenses" element={<AddExpences user={user}  />} />
          </Route> */}
          <Route path="/addTransaction/addIncome" element={<AddIncome user={user}  />} />
            <Route path="/addTransaction/addExpenses" element={<AddExpences user={user}  />} />
          <Route
            path="/trending"

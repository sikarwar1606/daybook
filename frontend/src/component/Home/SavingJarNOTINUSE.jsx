...
export default function SavingJar({
  ...
  const level = 320 - clamped * 230; // y of the water surface (110 = full, 340 = empty)
  ...
  return (
    <svg
      ...
      style={{ display: "block", maxWidth, margin: "100 auto" }}
    >
      ...
      <g clipPath={`url(#${clipId})`}>
        ...
        <g className="sj-slosh">
          <g transform={`translate(75,${level - 4})`}>
            <g className="sj-w2">
              <path d={WAVE_B} fill="#7CC4EC" opacity="0.7" />
            </g>
          </g>
      ...
      {/* Glass outline */}
      <path d={JAR_PATH} fill="none" stroke="#7FA9BF" strokeWidth="2" />

...
const AddTransaction = ({ user }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6">
      <h2 className="text-2xl font-bold text-gray-800 mb-8">Add Transaction</h2>

      <div className="flex flex-col sm:flex-row gap-6 w-full max-w-md">
        <Link to="addIncome">
          <button className="group relative flex-1 flex flex-col items-center gap-3 bg-white rounded-2xl p-8 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100">
